<div class="container-fluid acerca">
    <div class="row">
        <div class="col-md-12">
            <p>
                Pizhub es un proyecto creado en 2017 por 3 compañeros de estudios. Tras un polémico debate en su clase sobre las pizzas y más en concreto sobre los ingredientes que deberían o no llevar dichos manjares, coincidieron en su opinión y decidieron ponerle solución al problema desarrollando y poniendo en funcionamiento el proyecto Pizhub.
            </p>
            <blockquote>
                <p>
                    La pizza con piña, no es pizza.
                </p> <small>Paulo Coelho.</small>
            </blockquote>
            <p>
                Para evitar todo tipo de conflicto, los 3 compañeros decidieron unir sus fuerzas contra la piña como ingrediente, y así preservar el sabor y la entereza de las pizzas más históricas. El proyecto en principio decidió omitir cualquier alusión al ingrediente prohibido, pero la lucha no iba a ser tan fácil.
            </p>
            <p>
                Finalmente, y tras un breve estudio de mercado, el ingrediente prohibido se introdujo en el catálogo de productos, firmando así una paz con los ananófilos y mostrando con ellos un gran gesto de respeto y tolerancia con las minorías deficientes en el mundo pizzero.
            </p>
            <h1>
                Equipo Pizhub
            </h1>
                    ...
                    <div class="card-container manual-flip">
                        <div class="card">
                            <div class="front">
                                ...
                                <div class="user">
                                    <img class="img-circle" src="http://img.desmotivaciones.es/201202/hombreinglescalvo300x350.jpg"/>
                                </div>
                                <div class="content">
                                    <div class="main">
