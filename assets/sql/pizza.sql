...
--
-- Host: localhost
-- Generation Time: May 31, 2017 at 09:24 AM
...
INSERT INTO `producto` (`id`, `nombre`, `tipo`, `precio`, `nref`, `imgsrc`) VALUES
(1, 'PERSONALIZADA', 'pizza', '18', 'pizpers', 'pizza5.png'),
(2, 'MARGARITA', 'pizza', '12', 'pizmarg', 'pizza1.png'),
(3, 'COMPLETA', 'pizza', '16', 'pizcomp', 'pizza2.png'),
(4, 'QUESERA', 'pizza', '15', 'pizques', 'pizza3.png'),
(5, 'VEGETARIANA', 'pizza', '15', 'pizvege', 'pizza4.png'),
(6, 'PEPERONI', 'pizza', '14', 'pizpepe', 'pizza6.png'),
(7, 'IBÉRICA', 'pizza', '16', 'piziber', 'pizza7.png'),
(8, 'BARBACOA', 'pizza', '14', 'pizbarb', 'pizza8.png'),
...
--
ALTER TABLE `producto`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;COMMIT;
